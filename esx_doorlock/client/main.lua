					...
					if isAuthorized then
						...
						if doorID.soundLib then
							if not doorID.locked then							
								TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 4.0, 'doorlock', 0.4)
								Wait(1000)
							else
								TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 4.0, 'doorlock', 0.4)
							end
							...
							if not doorID.locked then
								TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'doorlock', 0.4)
							else
								TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'doorlock', 0.4)
							end
						end
